      ...
      <div className="flex min-h-0 flex-1 flex-col gap-3">
        ...
        <div className="flex min-h-0 flex-1 flex-col gap-1">
          ...
          <div
            ...
            className="min-h-0 flex-1 overflow-y-auto rounded-md border border-gray-300 px-3 py-2 text-sm empty:before:text-gray-400 empty:before:content-[attr(data-placeholder)] [&_img]:my-2 [&_img]:max-w-full"
          />
        </div>
      </div>
    </div>
